...
Le guide utilisateur complet est dans [`docs/guide_utilisateur.md`](interface/Guide_interface.md), avec des variantes par système d'exploitation dans le même dossier.
